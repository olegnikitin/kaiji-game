    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form:form action="${pageContext.servletContext.contextPath}/config/handler" method="post"
                ...
                <form:errors path="botType" cssClass="error"/><br>
                <br>
                ${game_name}: <form:input type="text" path="gameName" size="20" class="form-control"/>
                <form:errors path="gameName" cssClass="error"/><br>
                ${user_name}: <form:input type="text" path="userName" size="20" class="form-control"/>
                ...
                ${round_timeout}:<form:input type="text" path="roundTimeout" size="20" class="form-control"/>
                <form:errors path="roundTimeout" cssClass="error"/><br>
                <br><br>
